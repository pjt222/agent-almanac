...
<!-- AUTO:START:overview -->
A documentation-only repository containing 21 guides, a skills library of 339 agentic skills, 69 agent definitions, and 16 team compositions following the [Agent Skills open standard](https://agentskills.io). There is no build system, no tests, and no compiled code — all content is markdown and YAML.
