...
<!-- AUTO:START:overview -->
A documentation-only repository containing 19 guides, a skills library of 334 agentic skills, 68 agent definitions, and 15 team compositions following the [Agent Skills open standard](https://agentskills.io). There is no build system, no tests, and no compiled code — all content is markdown and YAML.
