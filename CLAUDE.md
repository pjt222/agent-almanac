...
<!-- AUTO:START:overview -->
A documentation-only repository containing 17 guides, a skills library of 317 agentic skills, 65 agent definitions, and 13 team compositions following the [Agent Skills open standard](https://agentskills.io). There is no build system, no tests, and no compiled code — all content is markdown and YAML.
