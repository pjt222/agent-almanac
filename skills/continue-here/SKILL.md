...
description: >
  ...
  recent work, structuring the continuation file, and optionally configuring
  a SessionStart hook for automatic pickup. Use when ending a session with
  unfinished work, handing off context between sessions, or preserving
  task state that git alone cannot capture.
license: MIT
