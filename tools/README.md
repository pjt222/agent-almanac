...
node tools/agent-report.mjs --verify                                           # synthetic transcripts: 34 checks — all three exits, --nth, --count, --raw, the merge window, --
...
bash tools/review-bundle.sh --verify          # throwaway repo (rename, symlink, non-ASCII path, dirty tree, subdir run, three commits, a gitlink): 64 checks incl. 33 exit-2 refusals
