...
description: >
  Guide a person through Coordinate Remote Viewing (CRV) session
  following Stargate/SRI protocol. AI acts as monitor/tasker role,
  manages protocol progression, catches Analytical Overlay (AOL),
  redirects viewer through stages I-VI. Use when person wants to
  practice CRV and needs monitor to manage session protocol, when train
  viewer through staged CRV process, facilitate structured intuitive
  perception exercise, or develop non-local awareness skills that
