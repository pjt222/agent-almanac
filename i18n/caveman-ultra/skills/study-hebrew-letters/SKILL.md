...
description: >
  Study 22 Hebrew letters as mystical symbols. Letter forms, numerical
  values, elemental/planetary/zodiacal correspondences, Sefer Yetzirah
  attributions, contemplative meditation tech. Use → study letter's
  mystical dim beyond linguistic, learn SY mothers/doubles/simples,
  need correspondences (element/planet/zodiac), Hebrew letter viz/chant
  meditation, Tree of Life paths + assigned letters.
license: MIT
allowed-tools: Read
metadata:
