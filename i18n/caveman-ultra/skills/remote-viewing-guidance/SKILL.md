...
description: >
  Guide person through CRV session per Stargate/SRI protocol. AI = monitor/
  tasker → manage protocol, catch AOL, redirect viewer through stages I-VI.
  Use → person practices CRV + needs monitor, train viewer through staged
  CRV, facilitate structured intuitive perception, develop non-local awareness
