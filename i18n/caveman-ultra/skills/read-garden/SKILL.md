...
description: >
  Observe + assess garden via structured sensory protocol from CRV. Pre-entry
  clear (meditate), Stage I gestalt, Stage II sensory (leaf, stem, root,
  soil), Stage III pattern + AOL mgmt, triage matrix (heal). Use → before
  intervention, plant stress, seasonal trans, new site, regular monitor,
  after frost/heat.
license: MIT
allowed-tools: Read
metadata:
