...
- **必需**: USDA hardiness zone or geographic location (for frost dates)
- **必需**: Crops or plants to schedule
- **可选**: Calendar system preference (solar only, lunar, or biodynamic)
- **可选**: Garden size and bed count
- **可选**: Previous season's garden journal

## 步骤

### 第 1 步：Establish the Solar Framework
...
**预期结果：** Clear frost dates and growing season length for your specific location.

**失败处理：** If frost dates are unknown, use conservative estimates (add 2 weeks to average LSF for safe direct-sow date). Local garden clubs or agricultural extension offices are the best regional sources.

### 第 2 步：Overlay the Lunar Calendar
...
**预期结果：** Understanding of both lunar cycles and their garden applications.

**失败处理：** If lunar calendar feels overwhelming, start with just the synodic cycle (waxing = above-ground, waning = below-ground) and add the sidereal layer in the second season.

### 第 3 步：Integrate the Biodynamic Calendar (Optional — Advanced)
...
**预期结果：** Awareness of biodynamic day types and how to use the annual calendar.

**失败处理：** If biodynamic calendar is unavailable, the lunar phase calendar (Step 2) captures the most important timing signals. Add biodynamic day types when you have access to the annual calendar.

### 第 4 步：Build a Succession Planting Schedule
...
**预期结果：** A week-by-week planting calendar customized to your zone, with succession intervals noted.

**失败处理：** If the schedule feels overwhelming, pick your 3 most important crops and plan successions for those only. Add more crops in the second season once the rhythm is established.

### 第 5 步：Seasonal Task Schedule
...
**预期结果：** A seasonal framework that complements the weekly planting schedule.

**失败处理：** If tasks are consistently missed, the schedule may be too ambitious. Reduce the number of beds or crops until the rhythm feels sustainable.

### 第 6 步：Meditate Checkpoint — End-of-Season Reflection
...
**预期结果：** A reflective summary that grounds next year's planning in this year's reality.

**失败处理：** If reflection feels like self-criticism, reframe: the garden is the teacher. Every "failure" is data. The only real failure is not observing.
