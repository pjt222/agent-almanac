...
- **必需**: Physical access to the garden
- **必需**: Garden journal or notebook for recording observations
- **可选**: Previous observation records for comparison
- **可选**: Soil thermometer, pH test strips, moisture meter
- **可选**: Hand lens or magnifying glass (for pest/disease identification)

## 步骤

### 第 1 步：Meditate Checkpoint — Pre-Entry Clearing
...
**预期结果：** A calm, receptive state free from preconceptions about what you will find.

**失败处理：** If you cannot release expectations (strong anxiety about a specific plant, frustration from recent losses), acknowledge the emotion, write it down as "AOL: [concern]", and proceed. Naming it reduces its influence.

### 第 2 步：Stage I — Gestalt Impression
...
**预期结果：** A brief, holistic record of the garden's state without analysis or diagnosis.

**失败处理：** If you immediately start diagnosing (e.g., "the squash is wilting because..."), write "AOL: [diagnosis]" and return to pure observation. Analysis comes in Stage III.

### 第 3 步：Stage II — Sensory Layer
...
**预期结果：** A detailed sensory record for each bed or zone, using descriptive language only.

**失败处理：** If you catch yourself diagnosing (naming a disease, blaming a pest), write "AOL: [diagnosis]" and return to raw observation. The name comes later — the data comes first.

### 第 4 步：Stage III — Pattern Recognition
...
**预期结果：** One or more tentative diagnoses supported by multiple independent observations.

**失败处理：** If no clear pattern emerges, the garden may be healthy (not everything is a problem) or the signals may be too early to read. Record observations and reassess in one week. Time often clarifies what a single visit cannot.

### 第 5 步：Heal Checkpoint — Garden Health Triage
...
**预期结果：** A triaged action list with clear priorities and timeline.

**失败处理：** If everything feels like a red priority, you may be in anxiety mode rather than observation mode. Return to the meditate checkpoint (Step 1) and re-enter. True emergencies are rare — most garden problems develop slowly and can wait a day.

### 第 6 步：Record and Track
...
**预期结果：** A complete, dated observation record that can be compared to previous visits.

**失败处理：** If journaling feels burdensome, reduce to the minimum: date, weather, triage summary, and one observation per bed. Consistency matters more than detail.
