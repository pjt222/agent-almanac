...
- **必需**: Current season (spring, summer, autumn, winter) or liturgical season (Advent, Lent, Easter, Ordinary Time)
- **可选**: Access to outdoor natural space (garden, park, forest) — indoor practice possible but less ideal
- **可选**: Current life situation (burnout, grief, transition, stagnation) — informs practice focus
- **可选**: Duration preference (5-10 min brief, 15-20 min standard, 30+ min extended)
- **可选**: Experience level (beginner, intermediate, advanced)

## 步骤

### 第 1 步：Understand the Concept of Viriditas
...
**预期结果：** User understands viriditas as divine life force in creation, not mere aesthetic greenness. Recognizes viriditas/ariditas as a spectrum of vitality.

**失败处理：** If theological language feels inaccessible, frame viriditas as "life force" or "vitality" — the power that makes things grow, heal, and flourish. Proceed with meditation practice.

### 第 2 步：Preparation — Grounding and Centering
...
**预期结果：** User is settled, grounded, and mentally prepared for contemplative engagement. Distraction has decreased; awareness has sharpened.

**失败处理：** If mind is highly agitated or distracted, extend preparation phase. Add a body scan (feet → legs → torso → arms → head) to bring awareness into the body before proceeding.

### 第 3 步：Core Meditation — Observing Viriditas
...
**预期结果：** User has experienced contemplative attunement to viriditas, both in external nature and internal life force. Sense of connection to living world strengthened.

**失败处理：** If meditation feels abstract or ungrounded, reduce visualization and focus ONLY on breath awareness with natural surroundings. Viriditas practice requires less "doing" and more "allowing."

### 第 4 步：Seasonal Attunement
...
**预期结果：** Practice adapted to current season with appropriate focus (erupting/full/harvesting/resting). User recognizes viriditas as year-round force, not limited to spring/summer.

**失败处理：** If seasonal variation feels confusing, practice core meditation (Step 3) without seasonal overlay. Seasonal attunement is enrichment, not requirement.

### 第 5 步：Integration — Living as Viriditas
...
**预期结果：** User has concrete daily/weekly/monthly practices to sustain viriditas awareness beyond meditation sessions. Life becomes practice, not just scheduled sessions.

**失败处理：** If integration feels overwhelming, choose ONE daily micro-practice only (morning greeting of green world). Full integration takes months to years; start small.
