...
- **必需**: Garden hand tools to maintain
- **必需**: Sharpening stone (1000/3000 grit combination stone or diamond plate)
- **必需**: Light machine oil or camellia oil (tsubaki oil)
- **可选**: Wire brush, steel wool (fine grade)
- **可选**: Linseed oil (for wooden handles)
- **可选**: 220-grit sandpaper (for handle refinishing)
- **可选**: Replacement handles or hardware

## 步骤

### 第 1 步：Know the Eight Essential Tools
...
**预期结果：** Familiarity with the core tool set and each tool's primary function.

**失败处理：** If budget is limited, prioritize in this order: secateurs → trowel → hand fork → hori-hori. These four cover 90% of garden tasks.

### 第 2 步：After-Use Quick Clean (2-3 Minutes)
...
**预期结果：** Clean, dry tools returned to designated storage after every use.

**失败处理：** If rust has already started (orange spots on steel), it's not too late. See Step 3 for remediation.

### 第 3 步：Monthly Maintenance — Sharpening and Oiling
...
**预期结果：** All edged tools sharp enough to cut cleanly. All metal surfaces lightly oiled.

**失败处理：** If a blade has nicks or chips, more aggressive sharpening is needed — start with a coarser stone (400-600 grit) before finishing with 1000/3000. Deep damage may require professional grinding.

### 第 4 步：Rust Remediation
...
**预期结果：** Rust removed, tool functional, protective oil applied.

**失败处理：** If rust has pitted the blade deeply (visible craters), the tool has lost metal and may not hold a sharp edge. Consider replacement — a deeply pitted secateur blade can damage plant tissue, inviting disease.
...
**预期结果：** Smooth, oil-finished handles that shed water and prevent blisters.

**失败处理：** If handles are beyond repair (deep cracks, rot), replacement handles are available for quality tools. Most secateur, fork, and trowel manufacturers sell replacement handles.

### 第 6 步：Meditate Checkpoint — Winter Tool Care Ritual
...
**预期结果：** All tools in peak condition, stored properly for winter, gardener settled into the dormant season.

**失败处理：** If winter maintenance is skipped entirely, do a pre-spring emergency cleanup: wire brush all rust, sharpen everything, oil everything. It's never too late to start caring for your tools.
