...
- **必需**: Error message or symptom description
- **必需**: Which client (Claude Code, Claude Desktop, or both)
- **必需**: Which MCP server (mcptools, Hugging Face, custom)
- **可选**: Recent changes to configuration or environment

## 步骤

### 第 1 步：Identify the Client and Configuration
...
### 第 2 步：Test Server Independently
...
### 第 3 步：Diagnose Common Error Patterns
...
### 第 4 步：Check Network and Authentication
...
### 第 5 步：Verify JSON Configuration Syntax
...
### 第 6 步：Platform-Specific Debugging
