...
- **必需**: Species of tree (or climate zone for species selection guidance)
- **可选**: Current state of tree (age estimate, pot size, health, last repotting date)
- **可选**: Goal style (formal upright, informal upright, cascade, semi-cascade, literati, windswept, forest)
- **可选**: Season and current weather conditions
- **可选**: Experience level (beginner, intermediate, advanced)

## 步骤

### 第 1 步：Select or Assess the Species
...
**预期结果：** Species selected that matches climate, experience, and aesthetic goal.

**失败处理：** If unsure about species suitability, default to Chinese elm — it tolerates the widest range of conditions and forgives beginner mistakes.

### 第 2 步：Meditate Checkpoint — Sitting with the Tree
...
**预期结果：** Calm, unhurried state. A sense of the tree's natural movement and character.

**失败处理：** If unable to quiet the planning mind, do not proceed to structural pruning. Maintenance watering and feeding may continue without this checkpoint.
...
**预期结果：** Tree with cleaner silhouette, improved light penetration, and clear trunk line.

**失败处理：** If too much foliage was removed, move tree to sheltered spot with dappled light. Reduce watering slightly (less foliage = less transpiration). Do not fertilize until new growth appears.
...
**预期结果：** Branches held in desired position without bark damage. Wire will be removed in 3-6 months.

**失败处理：** If wire bites into bark, cut it off immediately. The scar will heal over 2-3 growing seasons. Apply cut paste to deep wounds.
...
**预期结果：** Tree stable in pot, soil drains freely when watered, no wobble in trunk.

**失败处理：** If tree shows severe wilting within days of repotting, too many roots were removed. Move to shade, mist foliage daily, and apply rooting hormone to next watering. Recovery takes 4-8 weeks.

### 第 6 步：Heal Checkpoint — Post-Repot Assessment
...
**预期结果：** Tree showing new bud activity and stable footing within 2-3 weeks.

**失败处理：** If no new growth at 6 weeks and indicators remain stressed, the tree may need to be removed from the bonsai pot and placed in a larger recovery container with standard potting mix for one full growing season.

### 第 7 步：Seasonal Care Calendar
...
**预期结果：** Year-round care rhythm established with seasonal transitions.

**失败处理：** If a seasonal task was missed (e.g., spring repot), wait until next year — out-of-season repotting is more dangerous than waiting.
