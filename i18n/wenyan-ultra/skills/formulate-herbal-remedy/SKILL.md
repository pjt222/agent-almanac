...
得：用者盡知：製、量、忌、監、整合。免責明。

敗：用者未自信→勸先從師製一次，後家中復。
...
3. **量不足**：古方濃於今茶→守古比
4. **忽忌**：孕、藥交皆重。疑則勿用
5. **以今代古**：Hildegard 用歐洲中世紀草→代用或失體質系
6. **期藥速**：草藥漸。急一至三日，慢二至四週最少
7. **獨方觀**：Hildegard 整全。飲食、祈、息、時節並行
