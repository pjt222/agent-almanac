...
description: >
  Eine Person durch eine Coordinate Remote Viewing (CRV) Sitzung nach dem
  Stargate/SRI-Protokoll fuehren. Die KI uebernimmt die Monitor/Tasker-Rolle,
  verwaltet den Protokollfortschritt, erkennt Analytical Overlay (AOL) und
  leitet den Betrachter durch die Stufen I-VI. Verwenden wenn eine Person
  CRV ueben moechte und einen Monitor zur Verwaltung des Sitzungsprotokolls
  benoetigt, beim Training eines Betrachters durch den gestuften CRV-Prozess,
  bei der Durchfuehrung einer strukturierten intuitiven Wahrnehmungsuebung
  oder bei der Entwicklung nicht-lokaler Bewusstseinsfaehigkeiten, die
  Heilungsarbeit ergaenzen.
license: MIT
allowed-tools: Read
metadata:
