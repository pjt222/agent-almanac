...
description: >
  Anwenden ant colony optimization and foraging theory to resource search,
  ...
  and adaptive foraging strategy selection. Verwenden wenn searching a large
  solution space where brute-force enumeration is impractical, balancing
  investment zwischen exploring new approaches and deepening known good ones,
