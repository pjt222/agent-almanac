...
description: >
  Eine beliebige Codebasis analysieren, um Funktionen, APIs und Datenquellen zu identifizieren, die sich zur Bereitstellung als MCP-Tools eignen, und ein Tool-Spezifikationsdokument erstellen. Verwenden bei der Planung eines MCP-Servers fuer ein bestehendes Projekt, beim Audit einer Codebasis vor der Einbindung als KI-zugaengliche Tool-Oberflaeche, beim Vergleich der Codebasis-Faehigkeiten mit bereits ueber MCP bereitgestellten Funktionen oder bei der Erstellung einer Tool-Spezifikation zur Uebergabe an scaffold-mcp-server.
license: MIT
