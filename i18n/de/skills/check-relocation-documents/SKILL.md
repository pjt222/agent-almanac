...
description: >
  Verifizieren document completeness fuer jede bureaucratic step of an EU/DACH
  relocation, flagging missing items and translation requirements. Use nach
  creating a relocation plan and vor beginning bureaucratic procedures, when
  preparing for a specific appointment (Buergeramt, Finanzamt), when unsure
  which documents need certified translation or apostille, nach receiving a
  rejection or request for additional documents, or as a periodic check waehrend
  the relocation process to ensure nothing wurde overlooked.
license: MIT
...
- [plan-eu-relocation](../plan-eu-relocation/SKILL.md) -- Erstellen the relocation plan that feeds into this document check
