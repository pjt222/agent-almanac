...
description: >
  Planen a complete EU/DACH relocation timeline with Abhaengigkeit mapping zwischen
  bureaucratic steps, deadline tracking, and country-specific procedure
  identification. Verwenden wenn planning a move zwischen EU/DACH countries, relocating
...
- [check-relocation-documents](../check-relocation-documents/SKILL.md) -- Verifizieren document completeness fuer jede bureaucratic step
