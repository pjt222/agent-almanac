...
description: >
  Magnetische Levitationssysteme analysieren durch Anwendung des Earnshaw-Theorems zur Bestimmung, ob passive statische Levitation moeglich ist, und anschliessendes Identifizieren des geeigneten Umgehungsmechanismus (diamagnetisch, supraleitend, aktive Rueckkopplung oder spinsstabilisiert). Verwenden bei der Bewertung von Maglev-Transport, magnetischen Lagern, supraleitender Levitation, diamagnetischer Suspension oder Levitron-artigen Geraeten. Umfasst Kraftgleichgewichtsberechnungen, Stabilitaetsanalyse in allen raeumlichen und Kipp-Modi sowie Unterscheidungen zwischen Meissner-Effekt und Flussfixierung.
license: MIT
