...
description: >
  Semantische Versionierung (SemVer 2.0.0) anwenden, um anhand einer Aenderungsanalyse den korrekten Versionssprung zu bestimmen. Umfasst Major/Minor/Patch-Klassifikation, Pre-Release-Kennzeichnungen, Build-Metadaten und Erkennung brechender Aenderungen. Verwenden bei der Vorbereitung eines neuen Releases zur Bestimmung der korrekten Versionsnummer, nach dem Zusammenfuehren von Aenderungen vor dem Tagging, bei der Bewertung ob eine Aenderung eine brechende Aenderung darstellt, beim Hinzufuegen von Pre-Release-Kennzeichnungen oder bei Meinungsverschiedenheiten ueber den angemessenen Versionssprung.
license: MIT
