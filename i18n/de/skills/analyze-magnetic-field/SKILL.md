...
description: >
  Magnetfelder berechnen und visualisieren, die von Stromverteilungen erzeugt werden, mittels Biot-Savart-Gesetz, Ampere-Gesetz und magnetischer Dipol-Naeherung. Verwenden bei der Berechnung von B-Feldern aus beliebigen Stromgeometrien, bei der Ausnutzung von Symmetrie mit dem Ampere-Gesetz, bei der Analyse der Superposition mehrerer Quellen oder bei der Charakterisierung magnetischer Materialien durch Permeabilitaet, B-H-Kurven und Hystereseverhalten.
license: MIT
