...
**Esperado:** Primary requirement identified (e.g., "outdoor UV resistance" or "high impact strength").

**En caso de fallo:** If multiple requirements are equally critical, use decision matrix to score materials across requirements (see step 6).
...
**Esperado:** 2-5 candidate materials remain after filtering.

**En caso de fallo:** If no materials pass all filters, relax least-critical requirement or consider post-processing (e.g., UV coating for PLA).
...
**Esperado:** Material properties compared, 1-3 top candidates identified based on requirements.

**En caso de fallo:** If properties unclear, consult manufacturer technical datasheets via WebFetch tool.
...
**Esperado:** Printability assessed relative to printer capabilities and user experience. Decision balances performance needs vs. practical constraints.

**En caso de fallo:** If material too difficult for current setup, choose easier alternative and compensate with design changes (thicker walls, fillets, etc.).
...
**Esperado:** Special requirements verified against material capabilities.

**En caso de fallo:** If material doesn't meet special requirement, apply post-processing (e.g., UV-resistant coating on PLA) or choose different material.
...
**Esperado:** Final material selected with documented rationale based on weighted priorities.

**En caso de fallo:** If decision unclear, default to PETG for FDM or Tough Resin for SLA (best all-around compromises).
...
**Esperado:** Settings documented in project notes or slicer profile library.

**En caso de fallo:** Start with manufacturer recommended settings, then iterate and document successful changes.
