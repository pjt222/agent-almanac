...
- **Requerido**: Physical access to the garden
- **Requerido**: Garden journal or notebook for recording observations
- **Opcional**: Previous observation records for comparison
- **Opcional**: Soil thermometer, pH test strips, moisture meter
- **Opcional**: Hand lens or magnifying glass (for pest/disease identification)

## Procedimiento

### Paso 1: Meditate Checkpoint — Pre-Entry Clearing
...
**Esperado:** A calm, receptive state free from preconceptions about what you will find.

**En caso de fallo:** If you cannot release expectations (strong anxiety about a specific plant, frustration from recent losses), acknowledge the emotion, write it down as "AOL: [concern]", and proceed. Naming it reduces its influence.

### Paso 2: Stage I — Gestalt Impression
...
**Esperado:** A brief, holistic record of the garden's state without analysis or diagnosis.

**En caso de fallo:** If you immediately start diagnosing (e.g., "the squash is wilting because..."), write "AOL: [diagnosis]" and return to pure observation. Analysis comes in Stage III.

### Paso 3: Stage II — Sensory Layer
...
**Esperado:** A detailed sensory record for each bed or zone, using descriptive language only.

**En caso de fallo:** If you catch yourself diagnosing (naming a disease, blaming a pest), write "AOL: [diagnosis]" and return to raw observation. The name comes later — the data comes first.

### Paso 4: Stage III — Pattern Recognition
...
**Esperado:** One or more tentative diagnoses supported by multiple independent observations.

**En caso de fallo:** If no clear pattern emerges, the garden may be healthy (not everything is a problem) or the signals may be too early to read. Record observations and reassess in one week. Time often clarifies what a single visit cannot.

### Paso 5: Heal Checkpoint — Garden Health Triage
...
**Esperado:** A triaged action list with clear priorities and timeline.

**En caso de fallo:** If everything feels like a red priority, you may be in anxiety mode rather than observation mode. Return to the meditate checkpoint (Step 1) and re-enter. True emergencies are rare — most garden problems develop slowly and can wait a day.

### Paso 6: Record and Track
...
**Esperado:** A complete, dated observation record that can be compared to previous visits.

**En caso de fallo:** If journaling feels burdensome, reduce to the minimum: date, weather, triage summary, and one observation per bed. Consistency matters more than detail.
