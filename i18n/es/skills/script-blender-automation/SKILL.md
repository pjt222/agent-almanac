...
**Esperado:** Complex geometry generated from mathematical functions
**En caso de fallo:** Check BMesh API calls, verify vertex indexing, ensure faces are manifold
...
**Esperado:** Keyframes inserted, animation plays back correctly
**En caso de fallo:** Check property paths, verify data_path syntax, ensure objects are keyable
...
**Esperado:** Multiple files processed, renders generated for each variant
**En caso de fallo:** Check file paths exist, verify import operators, handle missing materials
...
**Esperado:** Operator appears in search, executes with proper undo support
**En caso de fallo:** Check bl_idname format (lowercase with underscores), verify property types
...
**Esperado:** Interactive operator responds to mouse, left-click confirms, ESC cancels
**En caso de fallo:** Check event types, ensure modal handler is added, handle no active object
...
**Esperado:** Add-on installs via Preferences, operators appear in menus
**En caso de fallo:** Check bl_info format, verify Blender version requirement, ensure all classes listed
...
**Esperado:** Objects created based on external data files
**En caso de fallo:** Validate file format, handle missing fields, provide default values
