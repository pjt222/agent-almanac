...
- **Requerido**: Ailment or condition to address (e.g., digestive upset, respiratory congestion, skin inflammation)
- **Opcional**: Known plant preferences or contraindications
- **Opcional**: Preparation preference (tincture for long-term use, infusion for acute, etc.)
- **Opcional**: User's temperament (sanguine, choleric, melancholic, phlegmatic) for tailored selection
- **Opcional**: Season and availability of fresh vs. dried herbs

## Procedimiento

### Paso 1: Identify the Plant in Physica
...
**Esperado:** One to three plants identified that match the ailment's pattern (hot/cold, dry/damp) and are appropriate for the user's constitution.

**En caso de fallo:** If unsure of the condition's pattern, default to balanced, gentle plants (fennel, chamomile, yarrow) which Hildegard describes as suitable for most constitutions.

### Paso 2: Select Preparation Method
...
**Esperado:** Preparation method selected that matches plant part (aerial vs. root), use case (acute vs. chronic), and application route (internal vs. external).

**En caso de fallo:** If uncertain, default to infusion — it is the safest and most forgiving method for beginners.

### Paso 3: Prepare the Remedy with Dosage
...
**Esperado:** Remedy prepared according to method, with correct herb-to-menstruum ratio and appropriate steep/extraction time. Dosage guidelines clear for internal or external use.

**En caso de fallo:** If preparation seems too strong (bitter, burning sensation), dilute by half. If too weak (no noticeable effect after 3 days at proper dosage), increase herb quantity by 50% in next batch.

### Paso 4: Document Contraindications
...
**Esperado:** All relevant contraindications identified for the selected plant(s), with specific populations flagged (pregnancy, children, drug interactions).

**En caso de fallo:** If uncertain about contraindications, advise the user to consult a qualified herbalist or healthcare provider before use. Default to "Not recommended during pregnancy, breastfeeding, or for children under 12 without professional guidance."

### Paso 5: Safety Review and Integration
...
**Esperado:** User has complete information: remedy preparation, dosage, contraindications, monitoring plan, and integration context. Safety disclaimers clear.

**En caso de fallo:** If user expresses uncertainty about self-preparation, recommend consulting a trained herbalist for first preparation, then replicating at home once confident.
