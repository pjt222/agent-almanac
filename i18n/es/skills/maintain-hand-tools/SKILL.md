...
- **Requerido**: Garden hand tools to maintain
- **Requerido**: Sharpening stone (1000/3000 grit combination stone or diamond plate)
- **Requerido**: Light machine oil or camellia oil (tsubaki oil)
- **Opcional**: Wire brush, steel wool (fine grade)
- **Opcional**: Linseed oil (for wooden handles)
- **Opcional**: 220-grit sandpaper (for handle refinishing)
- **Opcional**: Replacement handles or hardware

## Procedimiento

### Paso 1: Know the Eight Essential Tools
...
**Esperado:** Familiarity with the core tool set and each tool's primary function.

**En caso de fallo:** If budget is limited, prioritize in this order: secateurs → trowel → hand fork → hori-hori. These four cover 90% of garden tasks.

### Paso 2: After-Use Quick Clean (2-3 Minutes)
...
**Esperado:** Clean, dry tools returned to designated storage after every use.

**En caso de fallo:** If rust has already started (orange spots on steel), it's not too late. See Step 3 for remediation.

### Paso 3: Monthly Maintenance — Sharpening and Oiling
...
**Esperado:** All edged tools sharp enough to cut cleanly. All metal surfaces lightly oiled.

**En caso de fallo:** If a blade has nicks or chips, more aggressive sharpening is needed — start with a coarser stone (400-600 grit) before finishing with 1000/3000. Deep damage may require professional grinding.

### Paso 4: Rust Remediation
...
**Esperado:** Rust removed, tool functional, protective oil applied.

**En caso de fallo:** If rust has pitted the blade deeply (visible craters), the tool has lost metal and may not hold a sharp edge. Consider replacement — a deeply pitted secateur blade can damage plant tissue, inviting disease.
...
**Esperado:** Smooth, oil-finished handles that shed water and prevent blisters.

**En caso de fallo:** If handles are beyond repair (deep cracks, rot), replacement handles are available for quality tools. Most secateur, fork, and trowel manufacturers sell replacement handles.

### Paso 6: Meditate Checkpoint — Winter Tool Care Ritual
...
**Esperado:** All tools in peak condition, stored properly for winter, gardener settled into the dormant season.

**En caso de fallo:** If winter maintenance is skipped entirely, do a pre-spring emergency cleanup: wire brush all rust, sharpen everything, oil everything. It's never too late to start caring for your tools.
