...
**Esperado:** Clear understanding of target requirements
**En caso de fallo:** Contact publisher for specific guidelines, use conservative defaults
...
**Esperado:** Graphics rendered at correct resolution for print quality
**En caso de fallo:** Verify DPI metadata saved correctly, check file size appropriate
...
**Esperado:** Color space matches publication requirements
**En caso de fallo:** Verify color profile embedded, test print preview
...
**Esperado:** Text readable at publication size, fonts embedded properly
**En caso de fallo:** Increase font sizes, check font licensing, convert text to outlines
...
**Esperado:** Appropriate format for publication channel
**En caso de fallo:** Check publisher requirements, provide multiple formats
...
**Esperado:** Web-optimized images under 500KB, responsive sizes generated
**En caso de fallo:** Reduce quality, resize further, consider WebP format
...
**Esperado:** Metadata embedded and retrievable
**En caso de fallo:** Check format supports metadata (PNG, TIFF, PDF yes; JPEG limited)
