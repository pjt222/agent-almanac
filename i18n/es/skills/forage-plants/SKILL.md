...
- **Requerido**: A habitat to forage in (forest, meadow, wetland, shoreline)
- **Requerido**: Ability to observe fine plant details (leaf shape, arrangement, flower structure)
- **Opcional**: Field guide or reference material for the region
- **Opcional**: Container for collected plants
- **Opcional**: Knife for harvesting
- **Opcional**: Fire and water for preparation (see `make-fire`, `purify-water`)

## Procedimiento

### Paso 1: Know the Deadly Plants First
...
**Esperado:** You can recognize the most dangerous plants in your region on sight and will not confuse them with edible species.

**En caso de fallo:** If unsure about any plant in these families, do not eat it. The cost of a false positive (eating a deadly plant) is death. The cost of a false negative (skipping a safe plant) is a missed meal. Always err toward caution.

### Paso 2: Read the Habitat
...
**Esperado:** You identify which habitat type you are in and have a shortlist of likely edible species to look for.

**En caso de fallo:** If the habitat is unfamiliar or plant diversity is low (dense conifer forest, desert), focus on the universal species in Step 8. In arid environments, look for cacti pads (Opuntia), mesquite pods, or acorns from oaks. In deep forest, look for inner bark (cambium) of pine, birch, or basswood as emergency calories.

### Paso 3: Identify Using Multiple Features
...
**Esperado:** Positive identification based on at least 5 matching features. You can name the species and explain why it is not a dangerous look-alike.

**En caso de fallo:** If any feature does not match your reference, do not eat the plant. Set it aside and move to another candidate. Look-alikes are the primary cause of foraging poisoning — wild carrot (edible) vs. poison hemlock (deadly) differ in stem markings and smell but share leaf shape.

### Paso 4: Apply the Universal Edibility Test (Emergency Only)
...
**Esperado:** After the full test protocol, you have a tentative edible plant, though with less certainty than a positive ID.

**En caso de fallo:** If any reaction occurs at any stage, spit out or induce vomiting if swallowed. Drink water. Do not re-test the same plant. Move to a different species. If vomiting or diarrhea occur, focus on hydration and rest before resuming the test with another plant.

### Paso 5: Harvest Sustainably
...
**Esperado:** A reasonable quantity of positively identified plant material, harvested without destroying the source population.

**En caso de fallo:** If the plant stand is too small (fewer than 10 individuals), take only a token sample or find a larger population elsewhere. Overharvesting in a survival situation is understandable, but in short-term scenarios, conservation ensures the resource is available in coming days.

### Paso 6: Prepare for Consumption
...
**Esperado:** Plant material is clean, prepared appropriately for the species, and ready to eat.

**En caso de fallo:** If you have no fire for cooking (see `make-fire`), limit foraging to species safe to eat raw. If taste is extremely bitter after preparation, the plant may contain high levels of tannins or alkaloids — do not force yourself to eat it. Discard and try another species.

### Paso 7: Monitor for Reactions
...
**Esperado:** You can identify all five universal plants on sight using multiple features and know which parts to eat and how to prepare them.

**En caso de fallo:** If none of these five are present in your area (e.g., desert, high arctic, tropical), consult region-specific references. These five are specific to temperate zones. In tropical environments, look for coconut palm, banana/plantain, taro (must cook), breadfruit, and moringa. In arid regions, look for prickly pear cactus (Opuntia), mesquite, and agave.
