...
- **Requerido**: Species of tree (or climate zone for species selection guidance)
- **Opcional**: Current state of tree (age estimate, pot size, health, last repotting date)
- **Opcional**: Goal style (formal upright, informal upright, cascade, semi-cascade, literati, windswept, forest)
- **Opcional**: Season and current weather conditions
- **Opcional**: Experience level (beginner, intermediate, advanced)

## Procedimiento

### Paso 1: Select or Assess the Species
...
**Esperado:** Species selected that matches climate, experience, and aesthetic goal.

**En caso de fallo:** If unsure about species suitability, default to Chinese elm — it tolerates the widest range of conditions and forgives beginner mistakes.

### Paso 2: Meditate Checkpoint — Sitting with the Tree
...
**Esperado:** Calm, unhurried state. A sense of the tree's natural movement and character.

**En caso de fallo:** If unable to quiet the planning mind, do not proceed to structural pruning. Maintenance watering and feeding may continue without this checkpoint.
...
**Esperado:** Tree with cleaner silhouette, improved light penetration, and clear trunk line.

**En caso de fallo:** If too much foliage was removed, move tree to sheltered spot with dappled light. Reduce watering slightly (less foliage = less transpiration). Do not fertilize until new growth appears.
...
**Esperado:** Branches held in desired position without bark damage. Wire will be removed in 3-6 months.

**En caso de fallo:** If wire bites into bark, cut it off immediately. The scar will heal over 2-3 growing seasons. Apply cut paste to deep wounds.
...
**Esperado:** Tree stable in pot, soil drains freely when watered, no wobble in trunk.

**En caso de fallo:** If tree shows severe wilting within days of repotting, too many roots were removed. Move to shade, mist foliage daily, and apply rooting hormone to next watering. Recovery takes 4-8 weeks.

### Paso 6: Heal Checkpoint — Post-Repot Assessment
...
**Esperado:** Tree showing new bud activity and stable footing within 2-3 weeks.

**En caso de fallo:** If no new growth at 6 weeks and indicators remain stressed, the tree may need to be removed from the bonsai pot and placed in a larger recovery container with standard potting mix for one full growing season.

### Paso 7: Seasonal Care Calendar
...
**Esperado:** Year-round care rhythm established with seasonal transitions.

**En caso de fallo:** If a seasonal task was missed (e.g., spring repot), wait until next year — out-of-season repotting is more dangerous than waiting.
