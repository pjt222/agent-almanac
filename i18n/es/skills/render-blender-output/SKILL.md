...
**Esperado:** Render engine configured with appropriate quality settings
**En caso de fallo:** Check engine name spelling, verify GPU availability for GPU rendering
...
**Esperado:** Output format and resolution configured correctly
**En caso de fallo:** Check format names are valid, verify color depth compatible with format
...
**Esperado:** Compositing nodes configured with post-processing effects
**En caso de fallo:** Check node type names, verify inputs exist, ensure link connections valid
...
**Esperado:** Output directory created, filepath configured with frame numbering
**En caso de fallo:** Check directory permissions, verify path syntax for OS
...
**Esperado:** Render passes enabled for advanced compositing
**En caso de fallo:** Check if passes available for current engine, verify view layer name
...
**Esperado:** Render executes, output files written to specified location
**En caso de fallo:** Check scene setup, verify camera exists, ensure output directory writable
...
**Esperado:** Renders generated for each camera in scene
**En caso de fallo:** Check cameras exist, verify each camera positioned correctly
...
**Esperado:** Render settings optimized for target hardware
**En caso de fallo:** Test with lower quality first, monitor memory usage
