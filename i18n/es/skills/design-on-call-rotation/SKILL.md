...
description: >
  Diseña rotaciones de guardia sostenibles con horarios equilibrados, políticas de
  escalada claras, gestión de la fatiga y procedimientos de traspaso. Minimiza el
  agotamiento mientras se mantiene la cobertura de respuesta a incidentes. Útil al
  configurar la guardia por primera vez, al escalar un equipo de 2-3 a 5+ ingenieros,
  al abordar el agotamiento de la guardia o la fatiga de alertas, al mejorar los tiempos
  de respuesta a incidentes, o después de que un post-mortem identifique problemas de
  traspaso.
locale: es
source_locale: en
