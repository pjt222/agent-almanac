...
description: >
  Guiar a una persona a través de una sesión de Visión Remota por Coordenadas
  (CRV) siguiendo el protocolo Stargate/SRI. La IA actúa en el rol de
  monitor/asignador de tareas, gestionando la progresión del protocolo,
  detectando Superposición Analítica (AOL), y redirigiendo al observador a
  través de las etapas I-VI. Usar cuando una persona quiere practicar CRV y
  necesita un monitor para gestionar el protocolo de sesión, al entrenar a un
  observador a través del proceso CRV por etapas, al facilitar un ejercicio
  de percepción intuitiva estructurado, o al desarrollar habilidades de
  conciencia no local que complementan el trabajo de sanación.
license: MIT
allowed-tools: Read
metadata:
