...
- **Requerido**: Current symptoms or health concerns (physical, mental, emotional)
- **Requerido**: Responses to temperament assessment questions (constitution, habits, preferences)
- **Opcional**: Age, sex, and general health history (for context)
- **Opcional**: Current season (for seasonal adjustment recommendations)
- **Opcional**: Existing dietary restrictions or preferences
- **Opcional**: Known temperament from previous assessment

## Procedimiento

### Paso 1: Temperament Assessment
...
**Esperado:** Dominant and secondary temperament identified, with score profile showing primary constitutional tendencies.

**En caso de fallo:** If all scores are within 2-3 points of each other, the person has a balanced temperament (unusual in Hildegard's system). Proceed with general recommendations avoiding extremes (no very hot or very cold foods).

### Paso 2: Elemental Balance Assessment
...
**Esperado:** Identification of 1-2 elemental imbalances (e.g., "Excess water with deficient fire" = cold/damp pattern with low vitality).

**En caso de fallo:** If symptom pattern is unclear or contradictory, default to the opposite qualities of the dominant temperament. Example: Choleric (hot/dry) feeling unwell likely has excess fire → recommend cooling/moistening.

### Paso 3: Dietary Recommendations
...
**Esperado:** Specific food recommendations tailored to temperament and current imbalance, with clear "favor/moderate/avoid" categories.

**En caso de fallo:** If dietary restrictions prevent following recommendations (e.g., vegetarian unable to eat lamb), substitute within the same elemental category (warming/cooling/moistening/drying). Consult the plant-based options within each category.

### Paso 4: Lifestyle and Seasonal Adjustments
...
**Esperado:** 3-5 specific lifestyle recommendations that address the identified imbalance and align with Hildegard's holistic view (body, mind, spirit, nature).

**En caso de fallo:** If recommendations feel overwhelming, prioritize ONE dietary change and ONE lifestyle change to begin. Full rebalancing takes weeks to months — start small.

### Paso 5: Integration and Monitoring
...
**Esperado:** User has clear timeline for change implementation, monitoring practices, and criteria for reassessment.

**En caso de fallo:** If user reports feeling worse after 1-2 weeks, reassess for overcorrection. Example: Adding too many warming foods to a choleric type could cause excess fire. Dial back to neutral foods temporarily.
