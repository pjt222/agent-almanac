...
- **Requerido**: A cut gemstone ready for polishing (cabochon dome shaped and smoothed, or faceted stone with all facets cut)
- **Requerido**: Species identification (polishing compound and lap selection depend on the material)
- **Opcional**: Cabbing machine with polishing wheels/pads (for cabochons)
- **Opcional**: Faceting machine with polishing laps (for faceted stones)
- **Opcional**: Polishing compounds: cerium oxide, aluminum oxide, diamond paste (various micron grades), tin oxide, chromium oxide
- **Opcional**: Polishing laps: tin, copper, ceramic, Batt (synthetic), BATT lap, Corian, Lucite, leather, felt
- **Opcional**: 10x loupe or gemological microscope for quality inspection

## Procedimiento

### Paso 1: Surface Preparation
...
**Esperado:** A scratch-free surface at the pre-polish grit level, thoroughly cleaned, with secure dopping. The surface should feel glass-smooth to the fingernail.

**En caso de fallo:** If scratches persist after repeated grinding at the fine grit, the stone may have directional hardness (common in corundum and kyanite). Try changing the grinding direction. If contamination is the issue, clean everything and replace the water supply.

### Paso 2: Pre-Polish Sequence (Cabochons)
...
**Esperado:** After completing the pre-polish sequence, the stone should have a uniform satin-smooth surface with no visible scratches under 10x magnification.

**En caso de fallo:** If scratches persist at a given grit, continue working at that grit — do not advance. If deep scratches will not come out, drop back one grit stage and re-grind. Contamination from coarser grits is the most common cause of persistent scratching.

### Paso 3: Polishing Compound and Lap Selection
...
**Esperado:** A fully polished surface with mirror-like lustre (faceted stones) or deep, even lustre (cabochons). No scratches visible under 10x magnification. Facet edges are sharp and meets are crisp.

**En caso de fallo:** Common polish problems and solutions:
...
**Esperado:** A gemstone with professional-quality polish — full lustre, no visible scratches under 10x, sharp facet edges or smooth dome, and clean of all residue. Ready for setting, display, or sale.

**En caso de fallo:** If specific areas fail inspection, you can spot-polish individual facets (faceted stones) or return to the polishing wheel for specific areas (cabochons). Do not re-polish the entire stone unless the defect is widespread.
