...
- **Requerido**: Category to consult (plants, stones, animals, fish, birds, elements, trees, reptiles, metals)
- **Requerido**: Specific item or property inquiry (e.g., "emerald", "fennel", "properties of fire element")
- **Opcional**: Application context (medicinal, symbolic, liturgical, practical)
- **Opcional**: Related temperament or ailment (to guide property interpretation)
- **Opcional**: Cross-reference request (e.g., "plants and stones for cold temperament")

## Procedimiento

### Paso 1: Identify the Category in Physica
...
**Esperado:** Correct book/category identified for the inquiry (e.g., "emerald" → Book IV Stones; "fennel" → Book I Plants).

**En caso de fallo:** If uncertain which category, search multiple. Example: "willow" could be Book I (plant) or Book III (tree) — Hildegard lists it in Book III as a tree with bark and wood properties.

### Paso 2: Extract Properties and Applications
...
**Esperado:** Properties extracted with temperature, moisture, medicinal use, and symbolic associations clearly noted.

**En caso de fallo:** If *Physica* entry is brief or unclear, supplement with known temperamental logic. Example: If Hildegard says only "it is warm," infer that it treats cold conditions and avoid in hot conditions.

### Paso 3: Cross-Reference Between Categories (Optional)
...
**Esperado:** Related items identified across 2-3 categories that share temperament, medicinal use, or symbolic meaning. Synergistic use suggested where appropriate.

**En caso de fallo:** If cross-references are unclear, focus on single-category lookup. Cross-referencing is enrichment, not essential for basic consultation.

### Paso 4: Application Guidance
...
**Esperado:** Clear, actionable guidance for using *Physica* knowledge in context (medicinal, spiritual, seasonal, scholarly). User knows what to do with the information.

**En caso de fallo:** If application is unclear, provide the raw *Physica* entry text and let user determine application. Hildegard's entries are often self-explanatory.

### Paso 5: Contextualize within Hildegard's Holistic System
...
**Esperado:** User understands *Physica* as one component of Hildegard's holistic system. Cross-references to temperament, viriditas, and liturgical context provided where relevant.

**En caso de fallo:** If integration feels complex, focus on immediate practical use (Step 4) and defer holistic integration for advanced study.
