...
- **Requerido**: Mushroom spawn (grain spawn, sawdust spawn, or plug spawn from a reputable supplier)
- **Requerido**: Substrate material (straw, hardwood sawdust, logs, or supplemented sawdust)
- **Opcional**: Pressure cooker or large pot (for substrate sterilization/pasteurization)
- **Opcional**: Growing containers (bags, buckets, or logs)
- **Opcional**: Spray bottle and humidity gauge
- **Opcional**: Thermometer for monitoring temperature

## Procedimiento

### Paso 1: Choose Your Species
...
**Esperado:** Species selected that matches your environment, substrate availability, and experience level.

**En caso de fallo:** If unsure, start with blue oyster mushroom (Pleurotus ostreatus) on straw. It is the most forgiving species for beginners.

### Paso 2: Prepare the Substrate
...
**Esperado:** Substrate is clean (pasteurized or sterilized), at correct moisture content, and cooled to room temperature.

**En caso de fallo:** If contamination appears after inoculation (green mold within the first week), the substrate was insufficiently pasteurized or the inoculation environment was too dirty. Start fresh with more rigorous pasteurization.
...
**Esperado:** Spawn is evenly distributed throughout the substrate in a clean container, ready for incubation.

**En caso de fallo:** If spawn does not seem to be colonizing after 7-10 days (no visible white growth), check temperature (too cold slows growth), substrate moisture (too dry inhibits growth), and spawn viability (old or heat-damaged spawn may be dead).
...
**Esperado:** Full colonization — the substrate is uniformly white with mycelium and smells pleasantly mushroomy.

**En caso de fallo:** Partial colonization with contamination means the race was lost. Start again with more spawn (higher ratio), better pasteurization, and cleaner inoculation practice.

### Paso 5: Initiate Fruiting
...
**Esperado:** Primordia (tiny mushroom pins) appear within 5-14 days of fruiting initiation.

**En caso de fallo:** If no pins appear after 2 weeks: check humidity (too dry is the most common cause), light (some species need light to pin), and temperature (too warm delays pinning for many species).

### Paso 6: Harvest and Manage Successive Flushes
...
**Esperado:** Fresh mushrooms harvested at optimal timing, with successive flushes extending the productive life of the substrate.

**En caso de fallo:** If yields are poor (small, sparse mushrooms), the substrate may be depleted or contaminated. Supplemented substrates produce higher yields. If contamination appears between flushes, the block's productive life is over — compost it.
