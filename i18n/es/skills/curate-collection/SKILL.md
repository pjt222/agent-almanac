...
- **Requerido**: Collection scope (subject areas, audience, formats)
- **Requerido**: Budget (annual acquisitions budget or one-time allocation)
- **Opcional**: Usage data (circulation statistics, hold requests, ILL requests)
- **Opcional**: Community or institutional profile (demographics, curriculum, research areas)
- **Opcional**: Existing collection development policy

## Procedimiento

### Paso 1: Define the Collection Development Policy
...
### Paso 2: Assess the Existing Collection
...
### Paso 3: Acquire Materials Strategically
...
### Paso 4: Weed the Collection (Deaccessioning)
...
### Paso 5: Provide Reader Advisory and Reference
