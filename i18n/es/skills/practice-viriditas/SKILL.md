...
- **Requerido**: Current season (spring, summer, autumn, winter) or liturgical season (Advent, Lent, Easter, Ordinary Time)
- **Opcional**: Access to outdoor natural space (garden, park, forest) — indoor practice possible but less ideal
- **Opcional**: Current life situation (burnout, grief, transition, stagnation) — informs practice focus
- **Opcional**: Duration preference (5-10 min brief, 15-20 min standard, 30+ min extended)
- **Opcional**: Experience level (beginner, intermediate, advanced)

## Procedimiento

### Paso 1: Understand the Concept of Viriditas
...
**Esperado:** User understands viriditas as divine life force in creation, not mere aesthetic greenness. Recognizes viriditas/ariditas as a spectrum of vitality.

**En caso de fallo:** If theological language feels inaccessible, frame viriditas as "life force" or "vitality" — the power that makes things grow, heal, and flourish. Proceed with meditation practice.

### Paso 2: Preparation — Grounding and Centering
...
**Esperado:** User is settled, grounded, and mentally prepared for contemplative engagement. Distraction has decreased; awareness has sharpened.

**En caso de fallo:** If mind is highly agitated or distracted, extend preparation phase. Add a body scan (feet → legs → torso → arms → head) to bring awareness into the body before proceeding.

### Paso 3: Core Meditation — Observing Viriditas
...
**Esperado:** User has experienced contemplative attunement to viriditas, both in external nature and internal life force. Sense of connection to living world strengthened.

**En caso de fallo:** If meditation feels abstract or ungrounded, reduce visualization and focus ONLY on breath awareness with natural surroundings. Viriditas practice requires less "doing" and more "allowing."

### Paso 4: Seasonal Attunement
...
**Esperado:** Practice adapted to current season with appropriate focus (erupting/full/harvesting/resting). User recognizes viriditas as year-round force, not limited to spring/summer.

**En caso de fallo:** If seasonal variation feels confusing, practice core meditation (Step 3) without seasonal overlay. Seasonal attunement is enrichment, not requirement.

### Paso 5: Integration — Living as Viriditas
...
**Esperado:** User has concrete daily/weekly/monthly practices to sustain viriditas awareness beyond meditation sessions. Life becomes practice, not just scheduled sessions.

**En caso de fallo:** If integration feels overwhelming, choose ONE daily micro-practice only (morning greeting of green world). Full integration takes months to years; start small.
