...
- **必須**: A cut gemstone ready for polishing (cabochon dome shaped and smoothed, or faceted stone with all facets cut)
- **必須**: Species identification (polishing compound and lap selection depend on the material)
- **任意**: Cabbing machine with polishing wheels/pads (for cabochons)
- **任意**: Faceting machine with polishing laps (for faceted stones)
- **任意**: Polishing compounds: cerium oxide, aluminum oxide, diamond paste (various micron grades), tin oxide, chromium oxide
- **任意**: Polishing laps: tin, copper, ceramic, Batt (synthetic), BATT lap, Corian, Lucite, leather, felt
- **任意**: 10x loupe or gemological microscope for quality inspection

## 手順

### ステップ1: Surface Preparation
...
**期待結果:** A scratch-free surface at the pre-polish grit level, thoroughly cleaned, with secure dopping. The surface should feel glass-smooth to the fingernail.

**失敗時:** If scratches persist after repeated grinding at the fine grit, the stone may have directional hardness (common in corundum and kyanite). Try changing the grinding direction. If contamination is the issue, clean everything and replace the water supply.

### ステップ2: Pre-Polish Sequence (Cabochons)
...
**期待結果:** After completing the pre-polish sequence, the stone should have a uniform satin-smooth surface with no visible scratches under 10x magnification.

**失敗時:** If scratches persist at a given grit, continue working at that grit — do not advance. If deep scratches will not come out, drop back one grit stage and re-grind. Contamination from coarser grits is the most common cause of persistent scratching.

### ステップ3: Polishing Compound and Lap Selection
...
**期待結果:** A fully polished surface with mirror-like lustre (faceted stones) or deep, even lustre (cabochons). No scratches visible under 10x magnification. Facet edges are sharp and meets are crisp.

**失敗時:** Common polish problems and solutions:
...
**期待結果:** A gemstone with professional-quality polish — full lustre, no visible scratches under 10x, sharp facet edges or smooth dome, and clean of all residue. Ready for setting, display, or sale.

**失敗時:** If specific areas fail inspection, you can spot-polish individual facets (faceted stones) or return to the polishing wheel for specific areas (cabochons). Do not re-polish the entire stone unless the defect is widespread.
