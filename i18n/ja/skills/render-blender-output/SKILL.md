...
**期待結果:** Render engine configured with appropriate quality settings
**失敗時:** Check engine name spelling, verify GPU availability for GPU rendering
...
**期待結果:** Output format and resolution configured correctly
**失敗時:** Check format names are valid, verify color depth compatible with format
...
**期待結果:** Compositing nodes configured with post-processing effects
**失敗時:** Check node type names, verify inputs exist, ensure link connections valid
...
**期待結果:** Output directory created, filepath configured with frame numbering
**失敗時:** Check directory permissions, verify path syntax for OS
...
**期待結果:** Render passes enabled for advanced compositing
**失敗時:** Check if passes available for current engine, verify view layer name
...
**期待結果:** Render executes, output files written to specified location
**失敗時:** Check scene setup, verify camera exists, ensure output directory writable
...
**期待結果:** Renders generated for each camera in scene
**失敗時:** Check cameras exist, verify each camera positioned correctly
...
**期待結果:** Render settings optimized for target hardware
**失敗時:** Test with lower quality first, monitor memory usage
