...
- **任意**: Prior engagement state — coming from `intrinsic` or `meditate` sets a higher baseline
...
**失敗時:** If authenticity feels forced (performing authenticity is still performing), return to `meditate` for genuine clearing. You cannot shine through effort — only through genuine engagement.
