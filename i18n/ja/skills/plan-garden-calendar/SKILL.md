...
- **必須**: USDA hardiness zone or geographic location (for frost dates)
- **必須**: Crops or plants to schedule
- **任意**: Calendar system preference (solar only, lunar, or biodynamic)
- **任意**: Garden size and bed count
- **任意**: Previous season's garden journal

## 手順

### ステップ1: Establish the Solar Framework
...
### ステップ2: Overlay the Lunar Calendar
...
### ステップ3: Integrate the Biodynamic Calendar (Optional — Advanced)
...
### ステップ4: Build a Succession Planting Schedule
...
### ステップ6: Meditate Checkpoint — End-of-Season Reflection
