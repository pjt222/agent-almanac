...
- **必須**: Current season (spring, summer, autumn, winter) or liturgical season (Advent, Lent, Easter, Ordinary Time)
- **任意**: Access to outdoor natural space (garden, park, forest) — indoor practice possible but less ideal
- **任意**: Current life situation (burnout, grief, transition, stagnation) — informs practice focus
- **任意**: Duration preference (5-10 min brief, 15-20 min standard, 30+ min extended)
- **任意**: Experience level (beginner, intermediate, advanced)

## 手順

### ステップ1: Understand the Concept of Viriditas
...
**期待結果:** User understands viriditas as divine life force in creation, not mere aesthetic greenness. Recognizes viriditas/ariditas as a spectrum of vitality.

**失敗時:** If theological language feels inaccessible, frame viriditas as "life force" or "vitality" — the power that makes things grow, heal, and flourish. Proceed with meditation practice.

### ステップ2: Preparation — Grounding and Centering
...
**期待結果:** User is settled, grounded, and mentally prepared for contemplative engagement. Distraction has decreased; awareness has sharpened.

**失敗時:** If mind is highly agitated or distracted, extend preparation phase. Add a body scan (feet → legs → torso → arms → head) to bring awareness into the body before proceeding.

### ステップ3: Core Meditation — Observing Viriditas
...
**期待結果:** User has experienced contemplative attunement to viriditas, both in external nature and internal life force. Sense of connection to living world strengthened.

**失敗時:** If meditation feels abstract or ungrounded, reduce visualization and focus ONLY on breath awareness with natural surroundings. Viriditas practice requires less "doing" and more "allowing."

### ステップ4: Seasonal Attunement
...
**期待結果:** Practice adapted to current season with appropriate focus (erupting/full/harvesting/resting). User recognizes viriditas as year-round force, not limited to spring/summer.

**失敗時:** If seasonal variation feels confusing, practice core meditation (Step 3) without seasonal overlay. Seasonal attunement is enrichment, not requirement.

### ステップ5: Integration — Living as Viriditas
...
**期待結果:** User has concrete daily/weekly/monthly practices to sustain viriditas awareness beyond meditation sessions. Life becomes practice, not just scheduled sessions.

**失敗時:** If integration feels overwhelming, choose ONE daily micro-practice only (morning greeting of green world). Full integration takes months to years; start small.
