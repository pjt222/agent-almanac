...
**期待結果:** Clear understanding of target requirements
**失敗時:** Contact publisher for specific guidelines, use conservative defaults
...
**期待結果:** Graphics rendered at correct resolution for print quality
**失敗時:** Verify DPI metadata saved correctly, check file size appropriate
...
**期待結果:** Color space matches publication requirements
**失敗時:** Verify color profile embedded, test print preview
...
**期待結果:** Text readable at publication size, fonts embedded properly
**失敗時:** Increase font sizes, check font licensing, convert text to outlines
...
**期待結果:** Appropriate format for publication channel
**失敗時:** Check publisher requirements, provide multiple formats
...
**期待結果:** Web-optimized images under 500KB, responsive sizes generated
**失敗時:** Reduce quality, resize further, consider WebP format
...
**期待結果:** Metadata embedded and retrievable
**失敗時:** Check format supports metadata (PNG, TIFF, PDF yes; JPEG limited)
