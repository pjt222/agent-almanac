...
- **必須**: Fibre source (cotton linters, recycled paper, kozo bark, or plant stalks)
- **必須**: Mould and deckle (a flat screen frame with a removable top frame)
- **必須**: Vat or tub large enough to submerge the mould (basin, plastic tub)
- **必須**: Water (generous amounts)
- **任意**: Blender for pulping (dedicated to paper making — not for food afterward)
- **任意**: Pressing boards and felt sheets (couching felts)
- **任意**: Sizing agent (gelatin, methylcellulose, or rice starch)
- **任意**: Additives: flower petals, threads, pigments, plant material for embedding

## 手順

### ステップ1: Prepare the Fibre
