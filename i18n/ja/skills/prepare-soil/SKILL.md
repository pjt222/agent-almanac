...
- **必須**: Access to the soil to be assessed (garden bed, field, or container)
- **任意**: Current soil test results (pH, N-P-K, organic matter %)
- **任意**: Garden history (previous crops, amendments applied, years cultivated)
- **任意**: Target crops or plants to be grown
- **任意**: Approach preference (organic, biodynamic, permaculture)

## 手順

### ステップ1: Assess the Soil
...
**期待結果:** Clear picture of soil texture, structure, and biology. A jar test result, a structure rating, and a worm count.

**失敗時:** If jar test layers are hard to distinguish, repeat with cleaner water and more vigorous shaking. If worm count is zero and soil smells sour, the soil may be anaerobic — drainage must be addressed before amendment.

### ステップ2: Diagnose and Plan Amendment
...
**期待結果:** A specific amendment plan matched to the diagnosed soil condition.

**失敗時:** If multiple conditions overlap (e.g., heavy clay AND depleted), address structure first (gypsum + broadfork), then biology (compost + cover crop). Trying to fix everything at once overwhelms the soil.
...
**期待結果:** Composting system established and first batch in progress.

**失敗時:** If hot compost won't heat up: check moisture (too dry or too wet), check C:N ratio (add more green for nitrogen), check pile size (below 1m³ won't heat reliably).

### ステップ4: Apply No-Till and Cover Cropping
...
**期待結果:** Soil protected year-round, biology undisturbed, organic matter increasing.

**失敗時:** If cover crop fails to establish, check sowing depth (most need surface or shallow sowing) and moisture. Resow or apply thick mulch as substitute ground cover.

### ステップ5: Biodynamic Preparations (Optional — Advanced)
...
**期待結果:** Preparations applied at correct time and moon phase. Soil biology activation visible over 1-2 seasons.

**失敗時:** If preparations are unavailable, good compost and cover cropping achieve 80% of the biological benefit. Preparations enhance but are not a substitute for sound soil management.

### ステップ6: Heal Checkpoint — Post-Amendment Assessment
...
**期待結果:** Measurable improvement in at least 2 of 3 indicators (structure, biology, drainage).

**失敗時:** If no improvement after 6 weeks, the issue may be deeper than topsoil amendment can address. Consider raised beds with imported soil mix as a parallel strategy while continuing to improve the in-ground soil over multiple seasons.
