...
- **必須**: Available time for the session (minimum 10 minutes, recommended 20-45 minutes)
- **必須**: The person has a space where they will not be interrupted
- **任意**: Technique preference (shamatha, vipassana, mantra; default: shamatha)
- **任意**: Experience level (beginner, intermediate, advanced; default: beginner)
- **任意**: Timer or bell available (phone timer is acceptable; suggest a gentle tone)

## 手順

### ステップ1: Guide Space Preparation
...
**期待結果:** A quiet, stable environment where the person can sit undisturbed for the planned session length.

**失敗時:** If no quiet space is available, suggest earplugs or accepting ambient sound as part of the practice. Note that outdoor sounds (wind, birds, water) can serve as meditation objects. The key requirement is no physical interruption.
...
**期待結果:** A stable posture the person can maintain without significant discomfort for the planned session length. They appear alert but not tense.

**失敗時:** If pain develops within the first 5 minutes, guide adjustment. Reassure that pain is not the practice — suggest switching to a more supported posture. Mention that leg numbness during longer sits is normal and passes, but shift if it becomes a strong distraction.

### ステップ3: Guide Breath Anchoring
...
**期待結果:** Attention rests on the breath for several consecutive cycles. The mind begins to settle. Thoughts still arise but there is awareness of the breath underneath them.

**失敗時:** If the mind scatters immediately, suggest a shorter count cycle (to 5 instead of 10). If counting feels mechanical, offer the alternative of simply noting "in" and "out" silently. Reassure that even 3 consecutive attended breaths is a strong start for beginners.

### ステップ4: Coach Distraction Handling
...
**期待結果:** Over the session, the person reports decreasing frequency of wandering and faster noticing. The gap between wandering and noticing narrows.

**失敗時:** If frustration builds, soften the approach: "Instead of concentrating hard, try simply being with the breath — like sitting by a river, not trying to control the water." If a thought or emotion is overwhelming, suggest using it as a temporary meditation object, then returning to breath when it passes.

### ステップ5: Guide Shamatha (Calm Abiding)
...
**期待結果:** A progressively calmer and more focused mind. Thoughts slow. Awareness of the present moment sharpens. Body feels settled and relaxed.

**失敗時:** If concentration does not deepen, check three things with the person: posture (slumping reduces alertness), breath (unconsciously controlling it — suggest releasing control), and expectation (wanting stillness is itself a distraction). Reassure that concentration develops over weeks and months, not within a single session.

### ステップ6: Guide Vipassana (Insight) — If Appropriate
...
**期待結果:** Moments of clear seeing where the arising and passing of phenomena is observed directly. A sense of spaciousness. Reduced identification with thought content.

**失敗時:** If vipassana feels destabilizing (rapid emotional shifts, anxiety, disorientation), guide immediate return to shamatha and breath anchoring. Note that insight practice can temporarily amplify difficult mind states — this is recognized in traditional practice and is best navigated with ongoing teacher support for advanced stages.

### ステップ7: Close the Session
...
**期待結果:** A smooth transition from meditative state to activity. Residual calm and clarity persist. No grogginess or disorientation.

**失敗時:** If they feel groggy, suggest 5 sharp breaths and stretching before standing. If the session surfaced unresolved emotion, offer brief journaling or walking meditation before resuming tasks. If the body is stiff, guide gentle stretching for 2-3 minutes.
