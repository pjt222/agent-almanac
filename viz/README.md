...
Force-graph explorer for the 325-skill, 66-agent, 15-team development platform. Built with [force-graph](https://github.com/vasturiano/force-graph), R/ggplot2 icon rendering, and 9 color themes.
...
- **325 skill icons** (`icons/<domain>/`): one glyph per skill, domain-colored
